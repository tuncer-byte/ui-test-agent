...
// ---------------------------------------------------------------
// NOTE: this is a bundled copy so the VS Code extension is self-contained
// and works in any workspace, not just this monorepo. Source of truth is
// webmcp-demo/agent-runner/codegen-agent.js — keep both in sync.
// ---------------------------------------------------------------
